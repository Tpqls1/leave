...
$(document).ready(function () {
	...
	// profile tab 영역 메뉴 관련 js
	var numberListsl = document.querySelectorAll('.number-profile-alignment > li > a');
	numberListsl.forEach(function (item) {
		item.addEventListener('click', function (event) {
	...
	// myProfile tab 영역 메뉴 관련 js
	var numberListse = document.querySelectorAll('.number-myProfile-alignment > li > a');
	numberListse.forEach(function (item) {
		item.addEventListener('click', function (event) {
