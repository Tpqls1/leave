	...
	<div class="container">
		<div class="wrapper">
			...
			<div class="search-content">
					...
					</select> <input type="text" placeholder="제목, 내용, 작성자로 검색" name="keyword" value="${pageMaker.cri.keyword}">
				...
				<div class="image-gallery-info">
							...
							<a href="profile.html">
								<div class="user-photo">
									<c:choose>
										...
										<c:otherwise>
											<img class="profile" src="/display?fileName=${profileImg}">
										</c:otherwise>
									</c:choose>
								</div>
		            ...
		            <div class="like">
		              <button id="like-click">
		              	<c:choose>
		              		<c:when test="${like == 1}">
		              		 <c:set var="like" value="like-img svg-like"/>
		              		</c:when>
		              		<c:otherwise>
		              		 <c:set var="like" value="like-img" />
		              		</c:otherwise>
		              	</c:choose>
