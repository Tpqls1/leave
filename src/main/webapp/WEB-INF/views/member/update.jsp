				...
				<div class="myProfile-main">
					<div class="myProfile-left-content">
						<ul class="number-line-alignment">
							<li><a href="/my/list?userid=${member.userid}"> 나의 게시물 </a></li>
							<li><a class="myContent-choice" href="/member/info">
									회원정보 </a></li>
						</ul>
					</div>
					<div class="memberInfo-right-content">
						<form role="form" action="/member/update" onsubmit="return checkMemInfo()"
                        ...
                        --></td>
									...
									<tr>
										<th>프로필사진 등록</th>
										<td><input type="file" name='uploadFile' accept="image/gif, image/jpeg, image/png" multiple></td>
									</tr>
...
$(document).ready(function(){
	...
	$("input[type='submit']").on("click",function(e){
		...
		$(".uploadResult ul li").each(function(i, obj){
			...
			str += "<input type='hidden' name='attachType' value='true'>'";
			str += "<input type='hidden' name='ano' value='0'>'";
		});
		console.log(str);
